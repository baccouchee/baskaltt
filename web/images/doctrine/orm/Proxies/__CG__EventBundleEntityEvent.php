...
class Event extends \EventBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'nom', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'cat', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'description', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'dateDeb', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'dateFin', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'emplacement', '' . "\0" . 'EventBundle\\Entity\\Event' . "\0" . 'photo'];
        }
