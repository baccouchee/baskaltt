...
//        if(isCurrentStats()) statsImage = selection;
        ...
        f.getToolbar().addMaterialCommandToLeftSideMenu("Mes Favoris ", FontImage.MATERIAL_FAVORITE, e -> new Wishlist(username).show());
        ...
        f.getToolbar().addMaterialCommandToLeftSideMenu("Article ", FontImage.	MATERIAL_FILTER_LIST, e -> new AllArticles(username).show());
        f.getToolbar().addMaterialCommandToLeftSideMenu("Voir Profile ", FontImage.MATERIAL_ACCOUNT_CIRCLE, e -> new ProfilForm(username).show());
        f.getToolbar().addComponentToSideMenu(new Label(" ", "SideCommand"));
        f.getToolbar().addComponentToSideMenu(new Label(" ", "SideCommand"));
        f.getToolbar().addComponentToSideMenu(new Label(" ", "SideCommand"));
        f.getToolbar().addComponentToSideMenu(new Label(" ", "SideCommand"));
